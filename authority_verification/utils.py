...
def extract_reference_point(input_paragraph: str, input_index: str, start_index: int):
	...
	for i in range(start_index, input_length):
						...
						if input_words[i + 4] == "Điều":
							...
							# điểm a khoản 1 Điều 1 ...
								...
								if input_words[i + 6] == "Chương":
									...
									elif input_words[i + 7].isalpha() and input_words[i + 7].isupper():
							...
							# điểm a khoản 1 Điều 1,
								...
								output.append(f"{index_list[0]}.{input_words[i + 5][:-1]}.{input_words[i + 3]}.{input_words[i + 1]}")
								return output, i + 5
				# điểm a và điểm ...
								...
								if input_words[i + 7] == "Điều":
									...
									# điểm a và điểm b khoản 1 Điều 1 ...
										...
										if input_words[i + 9] == "Chương":
											...
											elif input_words[i + 10].isalpha() and input_words[i + 10].isupper():
									...
									if input_words[i + j + 6] == "Điều":
										...
										# điểm a, b, c và đ khoản 1 Điều 1 ...
											...
											if input_words[i + j + 8] == "Chương":
												...
												elif input_words[i + j + 9].isalpha() and input_words[i + j + 9].isupper():
													for point in point_list:
		...
		if input_words[i].lower() == "điểm":
			...
			# điểm 1, ...
			elif input_words[i + 1].isnumeric() and input_words[i + 2][-1] == ",":
				point_list = []
				j = 0
				while input_words[i + j + 2][-1] == "," and input_words[i + j + 2][:-1].isnumeric():
					point_list.append(input_words[i + j + 2][:-1])
					j += 1
				# điểm 1, 2, 3 ...
				if input_words[i + j + 2].isnumeric():
					point_list.append(input_words[i + j + 2])
					# điểm 1, 2, 3 và ...
					if input_words[i + j + 3] == "và":
						# điểm 1, 2, 3 và 4 ...
						if input_words[i + j + 4].isnumeric():
							point_list.append(input_words[i + j + 4])
							# điểm 1, 2, 3 và 4 khoản ...
							if input_words[i + j + 5] == "khoản":
								# điểm 1, 2, 3 và 4 khoản này
								if input_words[i + j + 6] == "này":
									for point in point_list:
										output.append(f"{index_list[0]}.{index_list[1]}.{index_list[2]}.{point}")
									return output, i + j + 6
								# điểm 1, 2, 3 và 4 khoản 1 ...
								elif input_words[i + j + 6].isnumeric():
									# điểm 1, 2, 3 và 4 khoản 1 Điều ...
									if input_words[i + j + 7] == "Điều":
										# điểm 1, 2, 3 và 4 khoản 1 Điều này
										if input_words[i + j + 8] == "này":
											for point in point_list:
												output.append(f"{index_list[0]}.{index_list[1]}.{input_words[i + j + 6]}.{point}")
											return output, i + j + 8
										# điểm 1, 2, 3 và 4 khoản 1 Điều 1 ...
										elif input_words[i + j + 8].isnumeric():
											# điểm 1, 2, 3 và 4 khoản 1 Điều 1 Chương ...
											if input_words[i + j + 9] == "Chương":
												# điểm 1, 2, 3 và 4 khoản 1 Điều 1 Chương này
												if input_words[i + j + 10] == "này":
													for point in point_list:
														output.append(f"{index_list[0]}.{input_words[i + j + 8]}.{input_words[i + j + 6]}.{point}")
													return output, i + j + 10
												# điểm 1, 2, 3 và 4 khoản 1 Điều 1 Chương 1
												elif input_words[i + j + 10].isnumeric():
													for point in point_list:
														output.append(f"{input_words[i + j + 10]}.{input_words[i + j + 8]}.{input_words[i + j + 6]}.{point}")
													return output, i + j + 10
												# điểm 1, 2, 3 và 4 khoản 1 Điều 1 Chương I
												elif input_words[i + j + 10].isalpha() and input_words[i + j + 10].isupper():
													for point in point_list:
														output.append(f"{roman_to_int(input_words[i + j + 10])}.{input_words[i + j + 8]}.{input_words[i + j + 6]}.{point}")
													return output, i + j + 10
											# điểm 1, 2, 3 và 4 khoản 1 Điều 1 abcxyz ...
											elif input_words[i + j + 9] != "Chương":
												for point in point_list:
													output.append(f"{index_list[0]}.{input_words[i + j + 8]}.{input_words[i + j + 6]}.{point}")
												return output, i + j + 9
		...
		# khoản ...
			...
			# khoản này
			if input_words[i + 1] == "này":
				output.append(f"{index_list[0]}.{index_list[1]}.{index_list[2]}.0")
				return output, i + 1
			...
			# khoản 1 ...
				...
				if input_words[i + 2] == "Điều":
					# khoản 1 Điều này
					if input_words[i + 3] == "này":
						output.append(f"{index_list[0]}.{index_list[1]}.{input_words[i + 1]}.0")
						return output, i + 3
					# khoản 1 Điều 1 ...
					elif input_words[i + 3].isnumeric():
						...
						if input_words[i + 4] == "Chương":
							...
							if input_words[i + 5] == "này":
								output.append(f"{index_list[0]}.{input_words[i + 3]}.{input_words[i + 1]}.0")
								return output, i + 5
							...
							elif input_words[i + 5].isalpha() and input_words[i + 5].isupper():
						...
						# khoản 1 và điểm ... Điều 1 ...
							...
							if input_words[j + 2] == "Chương":
								...
								if input_words[j + 3] == "này":
									output.append(f"{index_list[0]}.{input_words[j + 1]}.{input_words[i + 1]}.0")
									return output, i + 1
								...
								elif input_words[j + 3].isalpha() and input_words[j + 3].isupper():
				...
				# khoản 1 và khoản 2 ...
					...
					if input_words[i + 4].isnumeric():
						...
						if input_words[i + 5] == "Điều":
							...
							if input_words[i + 6] == "này":
								output.append(f"{index_list[0]}.{index_list[1]}.{input_words[i + 1]}.0")
								output.append(f"{index_list[0]}.{index_list[1]}.{input_words[i + 4]}.0")
								return output, i + 6
							# khoản 1 và khoản 2 Điều 1 ...
								...
								if input_words[i + 7] == "Chương":
									...
									if input_words[i + 8] == "này":
										output.append(f"{index_list[0]}.{input_words[i + 6]}.{input_words[i + 1]}.0")
										output.append(f"{index_list[0]}.{input_words[i + 6]}.{input_words[i + 4]}.0")
										return output, i + 8
									...
									elif input_words[i + 8].isalpha() and input_words[i + 8].isupper():
							...
							# khoản 1 và khoản 2 Điều 1, ...
								...
								output.append(f"{index_list[0]}.{input_words[i + 6][:-1]}.{input_words[i + 1]}.0")
								output.append(f"{index_list[0]}.{input_words[i + 6][:-1]}.{input_words[i + 4]}.0")
								return output, i + 6						
				# khoản 1 abcxyz ...
				elif input_words[i + 2] != "và" and input_words[i + 2] != "khoản":
					output.append(f"{index_list[0]}.{index_list[1]}.{input_words[i + 1]}.0")
					...
					if input_words[i + j + 2] == "và":
						...
						if input_words[i + j + 3].isnumeric():
							...
							if input_words[i + j + 4] == "Điều":
								...
								if input_words[i + j + 5] == "này":
									for point in point_list:
										output.append(f"{index_list[0]}.{index_list[1]}.{point}.0")
									return output, i + j + 5
								# khoản 1, 2, 3 và 4 Điều 1 ...
									...
									if input_words[i + j + 6] == "Chương":
										...
										if input_words[i + j + 7] == "này":
											for point in point_list:
												output.append(f"{index_list[0]}.{input_words[i + j + 5]}.{point}.0")
											return output, i + j + 7
										...
										elif input_words[i + j + 7].isalpha() and input_words[i + j + 7].isupper():
											for point in point_list:
								...
								# khoản 1, 2, 3 và điểm ... Điều 1 ...
									...
									if input_words[k + 2] == "Chương":
										...
										if input_words[k + 3] == "này":
											for point in point_list:
												output.append(f"{index_list[0]}.{input_words[k + 1]}.{point}.0")
											return output, i + j + 1
										...
										elif input_words[k + 3].isalpha() and input_words[k + 3].isupper():
											for point in point_list:
		...
		# điều ...
			...
			# điều này
			if input_words[i + 1] == "này":
				output.append(f"{index_list[0]}.{index_list[1]}.0.0")
				return output, i + 1
			...
			# điều 1 ...
				...
				if i + 2 < input_length:
					...
					if input_words[i + 2] == "Chương":
						# điều 1 Chương này
						if input_words[i + 3] == "này":
							output.append(f"{index_list[0]}.{input_words[i + 1]}.0.0")
							return output, i + 3
						# điều 1 Chương 1
						elif input_words[i + 3].isnumeric():
							...
							return output, i + 3
						# điều 1 Chương I
						elif input_words[i + 3].isalpha() and input_words[i + 3].isupper():
					...
					if input_words[i + j + 2] == "và":
						...
						if input_words[i + j + 3].isnumeric():
							...
							if input_words[i + j + 4] == "Chương":
								...
								if input_words[i + j + 5] == "này":
									for point in point_list:
										output.append(f"{index_list[0]}.{point}.0.0")
									return output, i + j + 5
								...
								elif input_words[i + j + 5].isalpha() and input_words[i + j + 5].isupper():
									for point in point_list:
		...
		# chương ...
			...
			if i + 1 < input_length:
				# chương này
				if input_words[i + 1] == "này":
					output.append(f"{index_list[0]}.0.0.0")
					return output, i + 1
				...
				# chương I ...
				elif input_words[i + 1].isalpha() and input_words[i + 1].isupper():
